...
var WORLD = {
    ...
    deriveTile: function (x, y) {
        ...
        // ground
        let bottomtile = this.TILES.sand, giganticPerl = this.getPerlin(x + 20000, y - 20000, 10000), hugePerl = this.getPerlin(x, y, 5001), bigPerl = this.getPerlin(x, y), smallPerl = this.getPerlin(x, y, 10), smallPerlAlt = this.getPerlin(y, x, 11), biome = "wasteland";
