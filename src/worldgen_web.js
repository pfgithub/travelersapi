...
//// PASTE SITE CODE BELOW THIS LINE ===
...
!function(n){var t=n.noise={};function e(n,t,e){this.x=n,this.y=t,this.z=e}e.
prototype.dot2=function(n,t){return this.x*n+this.y*t};var r=[new e(1,1,0),new
e(-1,1,0),new e(1,-1,0),new e(-1,-1,0),new e(1,0,1),new e(-1,0,1),new e(1,0,-1)
,new e(-1,0,-1),new e(0,1,1),new e(0,-1,1),new e(0,1,-1),new e(0,-1,-1)],o=[151,
160,137,91,90,15,131,13,201,95,96,53,194,233,7,225,140,36,103,30,69,142,8,99,37,
240,21,10,23,190,6,148,247,120,234,75,0,26,197,62,94,252,219,203,117,35,11,32,57
,177,33,88,237,149,56,87,174,20,125,136,171,168,68,175,74,165,71,134,139,48,27,
...
141,128,195,78,66,215,61,156,180],a=new Array(512),w=new Array(512);t.seed=
function(n){n>0&&n<1&&(n*=65536),(n=Math.floor(n))<256&&(n|=n<<8);for(var t=0;t<
256;t++){var e;e=1&t?o[t]^255&n:o[t]^n>>8&255,a[t]=a[t+256]=e,w[t]=w[t+256]=r[e%
12]}},t.seed(WORLD.seed);var i=.5*(Math.sqrt(3)-1),s=(3-Math.sqrt(3))/6;t.
simplex2=function(n,t){var e,r,o=(n+t)*i,h=Math.floor(n+o),f=Math.floor(t+o),d=(
h+f)*s,u=n-h+d,v=t-f+d;u>v?(e=1,r=0):(e=0,r=1);var c=u-e+s,y=v-r+s,M=u-1+2*s,l=v
-1+2*s,p=w[(h&=255)+a[f&=255]],x=w[h+e+a[f+r]],q=w[h+1+a[f+1]],A=.5-u*u-v*v,m=.5
-c*c-y*y,z=.5-M*M-l*l;return 70*((A<0?0:(A*=A)*A*p.dot2(u,v))+(m<0?0:(m*=m)*m*x.
dot2(c,y))+(z<0?0:(z*=z)*z*q.dot2(M,l)))}}(this);




/// PASTE SITE CODE ABOVE THIS LINE
...
let YOU = {
    x: 584398943189032458902543,
    y: 5238954073254879025348907,
    char: "&"
};
}).call(noise);

module.exports.WORLD = world_outer;
